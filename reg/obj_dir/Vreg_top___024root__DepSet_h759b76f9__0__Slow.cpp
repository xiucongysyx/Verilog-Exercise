...
VL_ATTR_COLD void Vreg_top___024root___ctor_var_reset(Vreg_top___024root* vlSelf) {
    ...
    vlSelf->i_sed = VL_RAND_RESET_I(8);
    ...
    vlSelf->reg_top__DOT__u0_lfsr__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->reg_top__DOT__u0_lfsr__DOT__o_q_1 = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u0__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u1__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u2__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u3__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u4__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u5__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u6__o_q = VL_RAND_RESET_I(1);
    vlSelf->reg_top__DOT__u0_lfsr__DOT____Vcellout__u7__o_q = VL_RAND_RESET_I(1);
    vlSelf->__Vdly__reg_top__DOT__u0_lfsr__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->__Vdly__o_led = VL_RAND_RESET_I(8);
    vlSelf->__Vdly__reg_top__DOT__u0_lfsr__DOT____Vcellout__u0__o_q = VL_RAND_RESET_I(1);
